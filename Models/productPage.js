...
const productPageSchema = new mongoose.Schema(
  {
    ...
    hero: {
      ...
      title: { type: String, default: "Lead automation, built visually" },
      description: {
        type: String,
        default:
    ...
    workflowSection: {
      title: {
        type: String,
        default: "Everything your lead workflow needs",
      },
      description: {
        type: String,
        default:
    ...
    scaleSection: {
      title: { type: String, default: "Scale your lead automation" },
      description: {
        type: String,
        default: "A workflow engine built for every stage of your growth.",
      },
      cards: {
        type: [
          {
            iconName: { type: String, default: "FiMail" },
            title: { type: String, default: "" },
            description: { type: String, default: "" },
          },
        ],
    ...
    contactSection: {
      title: { type: String, default: "Talk to the team" },
      description: {
        type: String,
        default:
    ...
    footer: {
      copyrightText: {
        type: String,
        default: "© 2026 Replex Engine — AI powered lead automation",
      },
    },
  },
  { timestamps: true }
